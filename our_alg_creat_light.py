...
'''
The output indicates the number of sketch segments deployed on switch, rather than the complete sketch.
'''

with open("our_alg_light.py", 'w') as f:
    ...
    for switch in switch_list:
        f.write(switch + " = model.addVar(lb=0, ub=" + str(d) + ", vtype=gurobipy.GRB.INTEGER, name=\'" + switch + "\')\n")
    ...
    f.write("model.setObjectiveN(obj2, index=1, priority=2, name='obj2')\n")
    f.write("model.setObjectiveN(obj3, index=2, priority=1, name='obj3')\n")
    ...
    f.write("\n")
    f.write("with open(\"result_light.json\",\"w\") as f:\n")
